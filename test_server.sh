...
#git clone https://gitlab.crio.do/COHORT_ME_BUILDOUT_XMEME_ENROLL_1612436694845/muneersyed156-me_buildout_xmeme.git

# cd to the cloned repo directory
#cd muneersyed156-me_buildout_xmeme
